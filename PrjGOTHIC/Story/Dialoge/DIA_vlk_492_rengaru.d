...
func void dia_rengaru_gotyou_youthief()
{
	...
	if(Npc_HasItems(self,itmi_gold) >= 1)
	{
		...
		b_giveinvitems(self,other,5113,Npc_HasItems(self,itmi_gold));
	}
	else
	{
...
func void dia_rengaru_gotyou_anteil_gehtklar()
{
	...
	if(b_giveinvitems(self,other,5113,Npc_HasItems(self,itmi_gold) / 2))
	{
...
func void dia_rengaru_zeichen_info()
{
	...
	if((other.attribute[ATR_DEXTERITY] - ATTRIBUTEBONUS[5]) < 30)
	{
