...
func void jan_training_talente_info()
{
	...
	{
		Info_AddChoice(jan_training_talente,b_buildlearnstring("Nauka kowalstwa",b_getlearncosttalent(other,NPC_TALENT_SMITH)),jan_training_smith_common);
	};
	if(PLAYER_TALENT_SMITH[WEAPON_COMMON] == TRUE)
	{
		if((PLAYER_TALENT_SMITH[WEAPON_1H_SPECIAL_01] == FALSE) && (hero.guild == GIL_DJG))
		{
		...
		if((PLAYER_TALENT_SMITH[WEAPON_2H_SPECIAL_01] == FALSE) && (hero.guild == GIL_DJG))
		{
		...
		if((PLAYER_TALENT_SMITH[WEAPON_1H_SPECIAL_02] == FALSE) && (PLAYER_TALENT_SMITH[WEAPON_1H_SPECIAL_01] == TRUE) && (hero.guild == GIL_DJG))
		{
		...
		if((PLAYER_TALENT_SMITH[WEAPON_2H_SPECIAL_02] == FALSE) && (PLAYER_TALENT_SMITH[WEAPON_2H_SPECIAL_01] == TRUE) && (hero.guild == GIL_DJG))
		{
...
func void dia_jan_dragonscales_info()
{
	...
	{
		b_giveinvitems(other,self,4776,20);
...
func void dia_jan_dragonblood_1()
{
	...
	dragonbloodcount = 1;
	b_giveinvitems(other,self,4775,dragonbloodcount);
	...
	b_giveinvitems(self,other,5113,dragonbloodgeld);
	Info_ClearChoices(dia_jan_dragonblood);
	Info_AddChoice(dia_jan_dragonblood,DIALOG_BACK,dia_jan_dragonblood_back);
	if(Npc_HasItems(other,itat_dragonblood) >= 1)
	{
