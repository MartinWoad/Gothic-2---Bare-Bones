...
func void dia_gerold_stuff_info()
{
	...
	if(b_giveinvitems(other,self,4916,1) && b_giveinvitems(other,self,4898,1) && b_giveinvitems(other,self,4924,1) && b_giveinvitems(other,self,4914,1))
	{
		...
		b_giveinvitems(other,self,5731,1);
...
func void dia_gerold_setgornfree_info()
{
	...
	b_giveinvitems(self,other,5734,1);
...
func void dia_gerold_morefood()
{
	...
	if(GEROLD_FOODCOUNTER > 8)
	{
		...
		b_giveinvitems(self,other,5113,450);
	}
	else
	{
...
func void dia_gerold_food_kaese()
{
	...
	b_giveinvitems(other,self,4894,1);
	dia_gerold_morefood();
};
...
func void dia_gerold_food_wurst()
{
	...
	b_giveinvitems(other,self,4914,1);
	dia_gerold_morefood();
};
...
func void dia_gerold_food_fleisch()
{
	...
	b_giveinvitems(other,self,4904,1);
	dia_gerold_morefood();
};
...
func void dia_gerold_food_suppe()
{
	...
	if(b_giveinvitems(other,self,4912,1))
	{
	}
	else
	{
		b_giveinvitems(other,self,4906,1);
	};
	dia_gerold_morefood();
};
