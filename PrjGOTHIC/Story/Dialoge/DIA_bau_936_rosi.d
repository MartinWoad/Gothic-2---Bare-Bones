...
func void dia_rosi_onar_info()
{
	...
	AI_Output(self,other,"DIA_Rosi_ONAR_17_02");	//Wtedy wysy³amy kogoœ na farmê zarz¹dcy, i prosimy o pomoc.
...
func void dia_rosi_permkap1_info()
{
	...
	{
		AI_Output(self,other,"DIA_Rosi_PERMKAP1_17_02");	//Uwa¿aj na siebie, nie pozwól, by ciê dopadli.
	};
	AI_StopProcessInfos(self);
};
