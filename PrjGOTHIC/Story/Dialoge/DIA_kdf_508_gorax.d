...
func void dia_gorax_pickpocket_doit()
{
	if(other.attribute[ATR_DEXTERITY] >= 80)
	{
		...
		b_giveinvitems(self,other,5683,1);
...
func void dia_gorax_gold_info()
{
	...
	if(Npc_HasItems(other,itmi_gold) >= SUMME_KLOSTER)
	{
		...
		b_giveinvitems(other,self,5113,SUMME_KLOSTER);
	}
	else
	{
...
func void dia_gorax_aufgabe_info()
{
	...
	b_giveinvitems(self,other,5684,1);
...
func void dia_gorax_wurst_info()
{
	...
	if(WURST_GEGEBEN >= 13)
	{
		...
		b_giveinvitems(self,other,5555,2);
	}
	else
	{
...
func void dia_gorax_aufgabe2_info()
{
	...
	b_giveinvitems(self,other,4924,12);
...
func void dia_gorax_orlan_240()
{
	...
	if(b_giveinvitems(other,self,5113,240))
	{
...
func void dia_gorax_kdf_info()
{
	...
	b_giveinvitems(self,other,5685,1);
