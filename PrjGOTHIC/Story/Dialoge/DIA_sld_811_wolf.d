...
{
	if(Npc_KnowsInfo(other,dia_wolf_hallo) && ((other.guild == GIL_SLD) || (other.guild == GIL_DJG) || (MIS_BENGARSHELPINGSLD == LOG_SUCCESS)))
	{
		return TRUE;
	};
};
...
func void dia_wolf_teach_bow_1()
{
	...
	{
		b_teachfighttalentpercent(self,other,NPC_TALENT_BOW,1,40);
	}
	else
	{
...
func void dia_wolf_teach_bow_5()
{
	...
	{
		b_teachfighttalentpercent(self,other,NPC_TALENT_BOW,5,40);
	}
	else
	{
...
func void dia_wolf_stadt_info()
{
	...
	AI_Output(self,other,"DIA_Wolf_Stadt_08_03");	//I jeszcze te ci¹g³e rozkazy. Nie, nie ma mowy. Mo¿e i na farmie nie jest za du¿o do roboty, ale przynajmniej nikt mn¹ nie pomiata.
};
...
func void dia_wolf_bringplates_info()
{
	...
	b_giveinvitems(other,self,4755,10);
...
func void dia_wolf_armorready_info()
{
	...
	if(Npc_HasItems(self,itat_crawlerplate) >= 10)
	{
		...
		else
		{
			...
			b_giveinvitems(self,other,4837,1);
...
func void dia_wolf_bengar_geld()
{
	...
	if(b_giveinvitems(other,self,5113,WOLF_BENGAR_GELD))
	{
