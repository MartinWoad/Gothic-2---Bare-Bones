...
{
	if((KEROLOTH_TEACHPLAYER == TRUE) && (KEROLOTHS_BEUTELLEER == FALSE) && (DIA_KEROLOTH_TEACH_PERMANENT == FALSE) && (other.hitchance[NPC_TALENT_2H] < 30))
	{
		return TRUE;
	};
};
...
func void dia_keroloth_kap4_geldgefunden_info()
{
	...
	if(b_giveinvitems(other,self,5849,1))
	{
	...
	if(b_giveinvitems(other,self,5847,1))
	{
