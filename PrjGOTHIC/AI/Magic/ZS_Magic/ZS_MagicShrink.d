...
func int zs_magicshrink_loop()
{
	...
	{
		Npc_ChangeAttribute(self,ATR_HITPOINTS,-(self.attribute * 1) / 2);
		Npc_ChangeAttribute(self,ATR_HITPOINTS_MAX,-(self.attribute[ATR_HITPOINTS_MAX] * 1) / 2);
		Npc_ChangeAttribute(self,ATR_STRENGTH,-(self.attribute[ATR_STRENGTH] * 1) / 4);
