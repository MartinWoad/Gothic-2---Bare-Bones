...
const string PRINT_BlessMANA_MAX = "Innos wys³ucha³ ciê i zwiêkszy³ twoj¹ manê o + ";
...
const string PRINT_HITPOINTS_MISSING = "Za ma³o punktów trafieñ";
const string PRINT_HITPOINTS_MAX_MISSING = "Za ma³a pula punktów trafieñ";
const string PRINT_MANA_MISSING = "Za ma³o many";
const string PRINT_MANA_MAX_MISSING = "Za ma³a pula many";
const string PRINT_STRENGTH_MISSING = "Za ma³a si³a";
const string PRINT_DEXTERITY_MISSING = "Za ma³a zrêcznoœæ";
const string PRINT_MAGCIRCLES_MISSING = "Za s³abe wtajemniczenie magiczne uniemo¿liwia u¿ycie tej runy";
