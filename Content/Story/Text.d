...
const string MOBNAME_INNOS = "Pos¹¿ek Innosa";
...
const string TXT_SPELLS[68] =
{
	...
	"Do Miasta Portowego",
	"Do Klasztoru",
	"Do Maj¹tku Ziemskiego",
	"Do Xardasa",
	"Do Prze³êczy Khorinis",
	"Do Prze³êczy Górniczej Doliny",
	"Do Zamku",
...
const string NAME_SPL_PalRepelEvil = "Wypêdzenie Z³a";
...
const string NAME_SPL_Zap = "Pora¿enie";
...
const string NAME_Buergerin = "Obywatel";
...
const string NAME_Dam_Edge = "Obra¿enia sieczne:";
const string NAME_Dam_Blunt = "Obra¿enia obuchowe:";
const string NAME_Dam_Point = "Obra¿enia k³ute:";
const string NAME_Dam_Fire = "Obra¿enia od ognia:";
const string NAME_Dam_Magic = "Obra¿enia magiczne:";
const string NAME_Dam_Energy = "Obra¿enia od energii magicznej:";
const string NAME_Dam_Frost = "Odmro¿enie:";
const string NAME_Dam_Fly = "Obra¿enia od wiatru:";
const string NAME_Damage = "Obra¿enia:";
const string NAME_Damage_Max = "Obra¿enia maksymalne:";
const string NAME_RANGE = "Zasiêg:";
const string NAME_PerMana = " (na punkt many)";
const string NAME_DamagePerSec = "Obra¿enia/sek.";
const string NAME_Prot_Edge = "Obrona przed obra¿eniami siecznymi:";
const string NAME_Prot_Blunt = "Obrona przed obra¿eniami obuchowymi:";
const string NAME_Prot_Point = "Obrona przed obra¿eniami k³utymi:";
const string NAME_Prot_Fire = "Obrona przed ogniem:";
const string NAME_Prot_Magic = "Obrona przed energi¹ magiczn¹:";
const string NAME_Prot_Weapon = "Obrona przed wszelkim orê¿em:";
//const string NAME_Bonus_HP = "Premia punktów trafieñ:";
const string NAME_Bonus_HP = "Premia ¿ycia:";
...
const string NAME_COMBATSKILL_MARKSMAN = "Wymagana zdolnoœci walki na poziomie: Strzelec";
const string NAME_COMBATSKILL_MASTER = "Wymagana zdolnoœci walki na poziomie: Mistrz";
const string NAME_HealingPerMana = "Uleczenie/mana";
const string NAME_HealingPerCast = "Uleczenie:";
const string NAME_ItMw_1H_Common_01 = "Niestarannie Wykuty Miecz";
...
const string PRINT_ItemErhalten = " przedmiot(y/ów) otrzymano";
const string PRINT_ItemsErhalten = " przedmiot(y/ów) otrzymano";
...
const string PRINT_LearnMANA_MAX = "Moc magiczna + ";
const string PRINT_LearnSTRPotential = "Potencja³ si³owy + ";
const string PRINT_LearnDEXPotential = "Potencja³ zrêcznoœciowy + ";
const string PRINT_LearnMANA_MAXPotential = "Potencja³ magiczny + ";
const string PRINT_Learnhitpoints_MAX = "Punkty trafieñ + ";
const string PRINT_LearnLP = "Punkty nauki + ";
const string PRINT_LearnCircle_1 = "Opanowa³eœ pierwszy kr¹g magii";
const string PRINT_LearnCircle_2 = "Opanowa³eœ drugi kr¹g magii";
const string PRINT_LearnCircle_3 = "Opanowa³eœ trzeci kr¹g magii";
const string PRINT_LearnCircle_4 = "Opanowa³eœ czwarty kr¹g magii";
const string PRINT_LearnCircle_5 = "Opanowa³eœ pi¹ty kr¹g magii";
const string PRINT_LearnCircle_6 = "Opanowa³eœ szósty kr¹g magii";
const string PRINT_Learn1H = "Pos³ugiwanie siê broni¹ jednorêczn¹";
const string PRINT_Learn1H_and_2H = "Pos³ugiwanie siê broni¹ jedno- i dwurêczn¹";
const string PRINT_Learn2H = "Pos³ugiwanie siê broni¹ dwurêczn¹";
const string PRINT_Learn2H_and_1H = "Pos³ugiwanie siê broni¹ dwu- i jednorêczn¹";
const string PRINT_LearnBow = "Pos³ugiwanie siê ³ukiem";
const string PRINT_LearnBow_and_Crossbow = "Pos³ugiwanie siê ³ukiem i kusz¹";
const string PRINT_LearnCrossbow = "Pos³ugiwanie siê kusz¹";
const string PRINT_LearnCrossbow_and_Bow = "Pos³ugiwanie siê kusz¹ i ³ukiem";
const string PRINT_LearnPicklock = "Opanowa³eœ w³amywanie siê";
const string PRINT_LearnSneak = "Opanowa³eœ skradanie siê";
const string PRINT_LearnAcrobat = "Opanowa³eœ akrobatykê";
const string PRINT_LearnPickpocket = "Opanowa³eœ kradzie¿ kieszonkow¹";
const string PRINT_LearnSmith = "Pozna³eœ tajniki kowalstwa";
const string PRINT_LearnRunes = "Pozna³eœ tajniki tworzenia run";
const string PRINT_LearnAlchemy = "Pozna³eœ tajniki warzenia mikstur";
const string PRINT_LearnAlchemyInnosEye = "Opanowa³eœ ³adowanie Oka Innosa";
const string PRINT_LearnTakeAnimalTrophy = "Pozna³eœ tajniki zbierania trofeów zwierzêcych";
const string PRINT_LearnPalTeleportSecret = "Opanowa³eœ tworzenie tajemnej runy teleportacyjnej";
const string PRINT_NotEnoughLearnPoints = "Za ma³o Punktów Nauki!";
const string PRINT_LearnSTR1 = "Potencja³ si³owy + 1";
const string PRINT_LearnSTR5 = "Potencja³ si³owy + 5";
const string PRINT_LearnDEX1 = "Potencja³ zrêcznoœciowy + 1";
const string PRINT_LearnDEX5 = "Potencja³ zrêcznoœciowy + 5";
const string PRINT_LearnMANA1 = "Potencja³ magiczny + 1";
const string PRINT_LearnMANA5 = "Potencja³ magiczny + 5";
...
const string PRINT_SLEEPOVERRESTED = "Jesteœ zbyt wypoczêty, aby zasn¹æ";
const string PRINT_SLEEPOVERHUNGRY = "Jesteœ zbyt g³odny, aby zasn¹æ";
...
const string PRINT_NOCOMBATSKILL = "Brak mi odpowiednich zdolnoœci";
...
const string PRINT_BlessSTR = "Innos wys³ucha³ ciê i zwiêkszy³ twoj¹ si³ê o + ";
const string PRINT_BlessDEX = "Innos wys³ucha³ ciê i zwiêkszy³ twoj¹ zrêcznoœæ o + ";
const string PRINT_BlessMANA_MAX = "Innos wys³ucha³ ciê i zwiêkszy³ twoj¹ moc o + ";
const string PRINT_BlessHitpoints_MAX = "Innos wys³ucha³ ciê i zwiêkszy³ twoje punkty trafieñ o + ";
const string PRINT_BlessMANA = "Innos wys³ucha³ ciê i nape³ni³ ciê energi¹ magiczn¹";
const string PRINT_BlessHitpoints = "Innos wys³ucha³ twe proœby i uleczy³ ciê";
const string Print_BlessMana_Hit = "Dziêki ³asce Innosa czujesz siê niczym nowonarodzony";
...
const string Print_InnoseyeGiven = "Przekazano Oko Innosa";
const string Print_InnosEyeGet = "Otrzymano Oko Innosa";
const string PRINT_GotFourItems = "Otrzymano 4 przedmioty";
const string PRINT_STR1 = "Si³a + 1";
const string PRINT_MANA10 = "Mana + 10";
const string PRINT_DEX2 = "Zrêcznoœæ + 2";
...
const string PRINT_PICKLOCK_FAILURE = "Wytrych wypad³ z zamka";
const string PRINT_PICKLOCK_BROKEN = "Wytrych siê z³ama³";
const string PRINT_HITPOINTS_MISSING = "Wymagane ¿ycie: ";
const string PRINT_HITPOINTS_MAX_MISSING = "Wymagane ¿ycie: ";
const string PRINT_MANA_MISSING = "Wymagana mana: ";
const string PRINT_MANA_MAX_MISSING = "Wymagana moc magiczna: ";
const string PRINT_STRENGTH_MISSING = "Wymagana si³a: ";
const string PRINT_DEXTERITY_MISSING = "Wymagana zrêcznoœæ: ";
const string PRINT_MAGCIRCLES_MISSING = "Wymagany kr¹g:";
...
const string Print_InnosGoldCharity = "Oddaj z³oto potrzebuj¹cym";
const string Print_InnosCharity = "Oddaj je potrzebuj¹cym";
const string Print_InnosJustice = "Odpowiedz za swoje czyny";
...
const string PRINT_NoPreviousTechnique = "Wymaga znajomoœci prostszych technik";
const string PRINT_RequiredSkill = "Wymaga umiejêtnoœci pos³ugiwania broni¹ na poziomie: ";
...
const string PRINT_Learn1hAdvanced2 = "Eksperctwo broni jednorêcznych";
...
const string PRINT_Learn2hAdvanced2 = "Eksperctwo broni dwurêcznych";
