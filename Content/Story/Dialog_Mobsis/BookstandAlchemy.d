...
func void Use_BookstandALCHEMY3_S1()
{
	...
	if(Hlp_GetInstanceID(self) == Hlp_GetInstanceID(her))
	{
		...
		Doc_SetMargins(nDocID,-1,30,20,275,20,1);
		Doc_PrintLine(nDocID,1,"");
		Doc_PrintLines(nDocID,1,"Uwarzenie tych mikstur to najwy¿szy stopieñ alchemicznego wtajemniczenia i wymaga sporego doœwiadczenia. Mo¿na przyj¹æ, ¿e do takich prac powinny siê braæ tylko osoby, które umiej¹ sobie poradziæ ze ognistym czy leczniczym korzeniem. Ka¿da z tych mikstur wymaga u¿ycia szczawiu królewskiego.");
		Doc_PrintLine(nDocID,1,"");
		Doc_PrintLines(nDocID,1,"Mikstura szybkoœci ma mniej skomplikowan¹ recepturê (nie wymaga u¿ycia szczawiu królewskiego). Mo¿e ona zostaæ poprawnie uwarzona nawet przez alchemicznych nowicjuszy.");
		Doc_PrintLine(nDocID,1,"");
		Doc_Show(nDocID);
