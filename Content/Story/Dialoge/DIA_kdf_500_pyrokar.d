...
func void dia_pyrokar_test_info()
{
	...
	b_giveinvitems(self,other,5692,1);
...
func void dia_pyrokar_lernen_info()
{
	...
	AI_Output(self,other,"DIA_Pyrokar_Lernen_11_04");	//Karras jest na przyk³ad mistrzem przywo³ywania, a Hyglas mo¿e ciê nauczyæ tajników magii ognia.
...
{
	if((other.guild == GIL_KDF) && (KAPITEL < 4))
	{
		return TRUE;
	};
};
...
func void dia_pyrokar_backfromow_info()
{
	...
	AI_Output(self,other,"DIA_Pyrokar_BACKFROMOW_11_03");	//To ju¿ wiemy od Miltena. Co z ³adunkiem rudy dla Króla?
	...
	b_giveinvitems(self,other,5453,1);
...
func void dia_pyrokar_giveinnoseye_info()
{
	...
	b_giveinvitems(other,self,5775,1);
...
instance DIA_PYROKAR_NOVIZENCHASE(C_INFO)
{
	...
	description = "Uda³o siê wam ustaliæ, dok¹d zbieg³?";
};
...
{
	AI_Output(other,self,"DIA_Pyrokar_NOVIZENCHASE_15_00");	//Uda³o siê wam ustaliæ, dok¹d zbieg³?
...
func void dia_pyrokar_xardasvertrauen_info()
{
	...
	b_logentry(TOPIC_INNOSEYE,"Pyrokar nie chce nawet s³yszeæ o Xardasie. Muszê porozmawiaæ z Xardasem, mo¿e wspólnie wymyœlimy, jak nak³oniæ Pyrokara do stawienia siê na rytuale w Krêgu S³oñca.");
...
func void dia_pyrokar_buchzurueck_info()
{
	...
	b_giveinvitems(other,self,5778,1);
	...
	b_logentry(TOPIC_INNOSEYE,"Pyrokar zgodzi³ siê pójœæ do Krêgu S³oñca.");
...
instance DIA_PYROKAR_PRERITUAL(C_INFO)
{
	...
	permanent = TRUE;
	description = "Myœlisz, ¿e zdo³asz naprawiæ Oko?";
};
...
func void dia_pyrokar_kap3_ready_info()
{
	...
	b_giveinvitems(self,other,5768,1);
...
func void dia_pyrokar_buchderbessenen_info()
{
	...
	if(hero.guild == GIL_KDF)
	{
		...
		b_giveinvitems(self,other,5787,1);
...
func void dia_pyrokar_scobsessed_info()
{
	if(((GOT_HEALOBSESSION_DAY <= (Wld_GetDay() - 2)) || (GOT_HEALOBSESSION_DAY == 0)) && (Npc_HasItems(other,itpo_healobsession_mis) == FALSE))
	{
		if(hero.guild == GIL_KDF)
		{
			...
			b_giveinvitems(self,other,5810,2);
...
func void dia_pyrokar_almanachbringen_info()
{
	...
	else
	{
		...
		b_giveinvitems(other,self,5784,almanachcount);
	...
	b_giveinvitems(self,other,5113,almanachgeld);
};
...
func void dia_pyrokar_amulettofdeath_canhaveit()
{
	...
	b_giveinvitems(self,other,5892,1);
...
func void dia_pyrokar_potionofdeath_potion()
{
	...
	AI_Output(other,self,"DIA_Pyrokar_PotionofDeath_Potion_15_04");	//(przerywa) Œmiem w¹tpiæ.
