...
{
	AI_Output(self,other,"DIA_Ehnim_PERMKAP1_12_00");	//Ma³o jeszcze narobi³eœ? Lepiej, jak se pójdziesz.
	AI_StopProcessInfos(self);
};
...
func void dia_ehnim_moleratfett_was_fett_habenwill_ja()
{
	...
	if(b_giveinvitems(other,self,5113,EHNIM_MOLERATFETTOFFER))
	{
		...
		else
		{
			...
			b_giveinvitems(self,other,5113,EHNIM_MOLERATFETTOFFER);
