...
{
	if((MIS_KLOSTERARBEIT == LOG_RUNNING) && (SERGIO_SENDS == TRUE) && (KAPITEL < 3))
	{
		return TRUE;
	};
};
...
func void dia_isgaroth_vatras_info()
{
	...
	{
		if(b_giveinvitems(other,self,5673,1))
		{
		...
		b_giveinvitems(self,other,5249,2);
		b_giveplayerxp(XP_AMBIENT * 2);
	}
	else if(Npc_HasItems(other,itwr_vatrasmessage_open) == 1)
	{
		if(b_giveinvitems(other,self,5676,1))
		{
