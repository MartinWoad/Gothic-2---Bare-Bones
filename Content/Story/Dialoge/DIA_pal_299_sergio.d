...
{
	if(Npc_KnowsInfo(hero,PC_PrayShrine_Paladine) && (Npc_GetDistToWP(self,"NW_MONASTERY_CHAPELL_02") <= 1500) && (Kapitel < 3))
	{
		return TRUE;
	};
};
...
func void DIA_Sergio_Isgaroth_XP()
{
	...
	{
		B_AddFightSkill(other,NPC_TALENT_2H,1,TRUE);
	};
	Info_ClearChoices(DIA_Sergio_Isgaroth);
};
...
instance DIA_Sergio_Babo(C_Info)
{
	...
	description = "Czy móg³byœ poæwiczyæ trochê z Babo?";
};
...
{
	AI_Output(other,self,"DIA_Sergio_Babo_15_00");	//Czy móg³byœ poæwiczyæ trochê z Babo?
