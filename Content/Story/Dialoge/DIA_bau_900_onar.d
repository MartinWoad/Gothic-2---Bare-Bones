...
func void dia_onar_aufstand_info()
{
	...
	AI_Output(self,other,"DIA_Onar_Aufstand_14_03");	//Nie mam zamiaru pozwoliæ kilku g³upim imbecylom, p³aszcz¹cym siê przed królem, na rozszabrowanie mego rodzinnego maj¹tku, tylko po to, by nakarmiæ wojska.
...
func void dia_onar_collectgold_info()
{
	...
	else
	{
		if(other.exp > (ONAR_SOLD_XP + 200))
		{
			...
			b_giveinvitems(other,self,5113,SOLD);
			b_say_gold(self,other,SOLD);
		}
		else
		{
