...
func void dia_hagen_petzmaster_paynow()
{
	...
	b_giveinvitems(other,self,5113,HAGEN_SCHULDEN);
...
instance DIA_LORD_HAGEN_TRESPASS(C_INFO)
{
	npc = pal_200_hagen;
	nr = 2;
	condition = dia_lord_hagen_trespass_condition;
	information = dia_lord_hagen_trespass_info;
	important = TRUE;
	permanent = TRUE;
};


func int dia_lord_hagen_trespass_condition()
{
...
func void dia_lord_hagen_trespass_info()
{
	AI_Output(self,other,"DIA_Hagen_PMSchulden_04_01");	//Widzê, ¿e lekcewa¿ysz prawa tego miasta, co?
	AI_Output(self,other,"DIA_Hagen_PETZMASTER_04_11");	//Pogwa³cenie miejskiego prawa to z³amanie prawa ustanowionego przez Innosa.
	AI_Output(self,other,"DIA_Hagen_PETZMASTER_04_12");	//Dlatego musisz zap³aciæ za swoje przewinienia.
...
func void dia_lord_hagen_frieden_info()
{
	...
	b_giveinvitems(other,self,5693,1);
...
func void dia_lord_hagen_pass_info()
{
	...
	b_giveinvitems(self,other,5747,1);
...
{
	if((KAPITEL >= 5) && (LORDHAGEN_TEACH2H == FALSE) && (other.guild == GIL_PAL) && (other.hitchance[NPC_TALENT_2H] >= 50) && (other.hitchance[NPC_TALENT_2H] < 60))
	{
		return TRUE;
	};
};
...
{
	if((HAGEN_GAVEINFOKNIGHT == TRUE) && (MIS_RITUALINNOSEYEREPAIR != LOG_SUCCESS))
	{
		return TRUE;
	};
};
...
func void dia_lord_hagen_backintown_info()
{
	...
	b_giveinvitems(other,self,5728,1);
	b_usefakescroll();
	...
	b_giveinvitems(self,other,5775,1);
...
func void dia_lord_hagen_antipaladine_info()
{
	...
	if(Npc_HasItems(other,itri_orcelitering))
	{
		...
		b_giveinvitems(other,self,5853,1);
...
func void dia_lord_hagen_ringebringen_info()
{
	...
	else
	{
		...
		b_giveinvitems(other,self,5853,ringcount);
	...
	b_giveinvitems(self,other,5113,orcringgeld);
};
