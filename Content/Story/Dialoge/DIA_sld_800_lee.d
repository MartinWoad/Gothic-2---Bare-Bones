...
func void b_lee_teleport()
{
	...
	b_giveinvitems(self,other,5454,1);
...
func void dia_lee_pmschulden_info()
{
	...
	if(b_getgreatestpetzcrime(self) != CRIME_NONE)
	{
		...
		Info_AddChoice(dia_lee_pmschulden,"Nie mam tyle pieniêdzy!",dia_lee_petzmaster_paylater);
...
func void dia_lee_petzmaster_info()
{
	...
	Info_ClearChoices(dia_lee_pmschulden);
	Info_ClearChoices(dia_lee_petzmaster);
	Info_AddChoice(dia_lee_petzmaster,"Nie mam tyle pieniêdzy!",dia_lee_petzmaster_paylater);
	if(Npc_HasItems(other,itmi_gold) >= LEE_SCHULDEN)
	{
...
func void dia_lee_petzmaster_paynow()
{
	...
	b_giveinvitems(other,self,5113,LEE_SCHULDEN);
...
func void dia_lee_tohagen_info()
{
	...
	b_giveinvitems(self,other,5693,1);
...
instance DIA_LEE_BUYARMORM(C_INFO)
{
	...
	permanent = TRUE;
	description = "Kup œredni pancerz najemnika. 500 sztuk z³ota.";
};
...
instance DIA_LEE_BUYARMORH(C_INFO)
{
	...
	permanent = TRUE;
	description = "Kup ciê¿ki pancerz najemnika. 1000 sztuk z³ota.";
};
...
func void dia_lee_richterbeweise_info()
{
	...
	b_giveinvitems(other,self,5829,1);
	b_usefakescroll();
...
{
	if((KAPITEL >= 5) && (LEE_TEACHPLAYER == FALSE))
	{
		return TRUE;
	};
};
...
func void dia_lee_canteach_yes()
{
	...
	b_giveinvitems(other,self,5113,1000);
...
func void dia_lee_stealship_info()
{
	...
	b_giveinvitems(self,other,5884,1);
};
