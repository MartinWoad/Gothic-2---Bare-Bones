...
func void dia_biff_geldeintreiben_geben()
{
	...
	AI_StopProcessInfos(self);
	b_giveinvitems(other,self,5113,BIFFSANTEIL);
	b_biff_setrefusetalk();
...
{
	if(b_giveinvitems(other,self,5251,1))
	{
		b_useitem(self,5251);
	}
	else if(b_giveinvitems(other,self,5249,1))
	{
		b_useitem(self,5249);
	}
	else if(b_giveinvitems(other,self,5247,1))
	{
		b_useitem(self,5247);
	}
	else
...
{
	if(b_giveinvitems(other,self,5247,1))
	{
		b_useitem(self,5247);
	}
	else if(b_giveinvitems(other,self,5249,1))
	...
	else if(b_giveinvitems(other,self,5251,1))
	{
		b_useitem(self,5251);
	}
	else
