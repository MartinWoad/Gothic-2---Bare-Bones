...
{
	if(b_teachfighttalentpercent(self,other,NPC_TALENT_CROSSBOW,1,60))
	{
...
{
	if(b_teachfighttalentpercent(self,other,NPC_TALENT_CROSSBOW,5,60))
	{
...
{
	if(b_teachfighttalentpercent(self,other,NPC_TALENT_1H,1,50))
	{
...
{
	if(b_teachfighttalentpercent(self,other,NPC_TALENT_1H,5,50))
	{
