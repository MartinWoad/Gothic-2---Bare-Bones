...
func int B_TeachPlayerTalentSmith(var C_Npc slf,var C_Npc oth,var int waffe)
{
	...
	if(waffe == WEAPON_1H_Special_01)
	{
		...
		B_LogEntry(TOPIC_TalentSmith,"Gdy otrzymam 1 bry³kê rudy, zrobiê ´D£UGI MIECZ Z RUDY´.");
	};
	if(waffe == WEAPON_2H_Special_01)
	{
		PLAYER_TALENT_SMITH[WEAPON_2H_Special_01] = TRUE;
		B_LogEntry(TOPIC_TalentSmith,"Gdy otrzymam 2 bry³ki rudy, zrobiê ´MIECZ DWURÊCZNY Z RUDY´.");
	};
	if(waffe == WEAPON_1H_Special_02)
	{
		PLAYER_TALENT_SMITH[WEAPON_1H_Special_02] = TRUE;
		B_LogEntry(TOPIC_TalentSmith,"Gdy otrzymam 2 bry³ki rudy, zrobiê ´MIECZ PÓ£TORARÊCZNY Z RUDY´.");
	};
	if(waffe == WEAPON_2H_Special_02)
	{
		PLAYER_TALENT_SMITH[WEAPON_2H_Special_02] = TRUE;
		B_LogEntry(TOPIC_TalentSmith,"Gdy otrzymam 3 bry³ki rudy, zrobiê ´CIÊ¯KI MIECZ DWURÊCZNY Z RUDY´.");
	};
	if(waffe == WEAPON_1H_Special_03)
	{
		PLAYER_TALENT_SMITH[WEAPON_1H_Special_03] = TRUE;
		B_LogEntry(TOPIC_TalentSmith,"Gdy otrzymam 3 bry³ki rudy, zrobiê ´OSTRZE BOJOWE Z RUDY´.");
	};
	if(waffe == WEAPON_2H_Special_03)
	{
		PLAYER_TALENT_SMITH[WEAPON_2H_Special_03] = TRUE;
		B_LogEntry(TOPIC_TalentSmith,"Gdy otrzymam 4 bry³ki rudy, zrobiê ´CIÊ¯KIE OSTRZE BOJOWE Z RUDY´.");
	};
	if(waffe == WEAPON_1H_Special_04)
	{
		PLAYER_TALENT_SMITH[WEAPON_1H_Special_04] = TRUE;
		B_LogEntry(TOPIC_TalentSmith,"Gdy otrzymam 4 bry³ki rudy i 5 porcji smoczej krwi, zrobiê ´OSTRZE Z RUDY NA SMOKI´.");
	};
