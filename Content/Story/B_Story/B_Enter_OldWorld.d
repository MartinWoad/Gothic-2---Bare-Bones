...
func void B_ENTER_OLDWORLD_Kapitel_3()
{
	if(EnterOW_Kapitel3 == FALSE)
	{
		...
		Wld_InsertItem(ItSc_Fear,"FP_ITEM_XARDASALTERTURM_01");
...
func void B_ENTER_OLDWORLD_Kapitel_4()
{
	if(EnterOW_Kapitel4 == FALSE)
	{
		...
		Wld_InsertNpc(OrcBiter,"SPAWN_OW_WARAN_ORC_01");
		...
		Wld_InsertNpc(OrcBiter,"FP_ROAM_ORK_OC_12");
		Wld_InsertNpc(OrcElite_Roam,"FP_ROAM_ORK_OC_07");
		Wld_InsertNpc(OrcWarrior_Roam,"OC9");
		Wld_InsertNpc(OrcBiter,"FP_ROAM_ORK_OC_28");
		...
		Wld_InsertNpc(OrcBiter,"FP_ROAM_OW_SCAVENGER_06_06");
		...
		Wld_InsertNpc(OrcBiter,"FP_ROAM_ORK_OC_22");
		Wld_InsertNpc(OrcBiter,"FP_ROAM_ORK_OC_11");
		Wld_InsertNpc(OrcElite_Roam,"FP_ROAM_ORK_OC_15");
		Wld_InsertNpc(OrcBiter,"FP_ROAM_ORK_OC_14");
		...
		Wld_InsertNpc(OrcBiter,"FP_ROAM_ORK_OC_03");
		...
		Wld_InsertNpc(OrcBiter,"FP_ROAM_ORK_OC_06");
		Wld_InsertNpc(OrcWarrior_Roam,"FP_ROAM_ORK_OC_05");
		Wld_InsertNpc(OrcBiter,"FP_CAMPFIRE_ORK_OC_09");
		Wld_InsertNpc(OrcWarrior_Roam,"FP_ROAM_ORK_OC_26");
		Wld_InsertNpc(OrcElite_Roam,"FP_ROAM_ORK_OC_10");
		Wld_InsertNpc(OrcBiter,"FP_ROAM_WARG_OC_14");
		Wld_InsertNpc(OrcWarrior_Roam,"FP_ROAM_WARG_OC_15");
		Wld_InsertNpc(OrcWarrior_Roam,"FP_ROAM_WARG_OC_11");
		Wld_InsertNpc(OrcBiter,"FP_ROAM_WARG_OC_12");
		Wld_InsertNpc(OrcWarrior_Roam,"OC_ROUND_28");
		Wld_InsertNpc(OrcBiter,"FP_ROAM_ORK_OC_13");
		Wld_InsertNpc(OrcBiter,"FP_ROAM_ORK_OC_14");
		...
		Wld_InsertNpc(OrcBiter,"SPAWN_O_SCAVENGER_OCWOODL2");
		...
		Wld_InsertNpc(OrcWarrior_Roam,"PATH_WALD_OC_WOLFSPAWN2");
		Wld_InsertNpc(OrcBiter,"PATH_WALD_OC_WOLFSPAWN2");
		...
		Wld_InsertNpc(OrcWarrior_Roam,"FP_ROAM_OW_SNAPPER_OW_ORC3");
		Wld_InsertNpc(OrcBiter,"FP_ROAM_OW_SNAPPER_OW_ORC");
		Wld_InsertNpc(OrcBiter,"FP_ROAM_OW_SNAPPER_OW_ORC");
		...
		Wld_InsertNpc(OrcBiter,"CASTLE_2");
		...
		Wld_InsertNpc(OrcBiter,"CASTLE_3");
		Wld_InsertNpc(OrcBiter,"CASTLE_4");
		Wld_InsertNpc(OrcBiter,"CASTLE_4");
