...
func void B_ENTER_NEWWORLD_Kapitel_3()
{
	if(EnterNW_Kapitel3 == FALSE)
	{
		...
		if((Npc_IsDead(b13) == FALSE) && (b13.guild == GIL_NONE))
		{
			EquipItem(self,ItMw_1h_Sld_Sword);
			B_SetAttributesToChapter(self,2);
			b13.guild = GIL_SLD;
			b13.name[0] = "Najemnik";
			B_SetNpcVisual(self,MALE,"Hum_Head_Fighter",Face_N_Homer,BodyTex_N,ItAr_Sld_L);
			Npc_ExchangeRoutine(b13,"MERCENARY");
		};
...
func void B_ENTER_NEWWORLD_Kapitel_4()
{
	if(EnterNW_Kapitel4 == FALSE)
	{
		...
		if((hero.guild == GIL_DJG) || (hero.guild == GIL_PAL) || (hero.guild == GIL_SLD) || (hero.guild == GIL_MIL))
		{
		...
		if((hero.guild == GIL_KDF) || (hero.guild == GIL_DJG) || (hero.guild == GIL_SLD))
		{
