...
const int INV_MAX_RUNES = 10;
const int INV_MAX_FOOD = 15;
const int INV_MAX_DOCS = 25;
const int INV_MAX_POTIONS = 20;
const int INV_MAX_MAGIC = 20;
const int INV_MAX_MISC = 25;
...
const int NPC_BURN_DAMAGE_POINTS_PER_INTERVALL = 30;
...
const int INVCAM_ENTF_RING_STANDARD = 0;
const int INVCAM_ENTF_AMULETTE_STANDARD = 0;
...
const int INVCAM_X_RING_STANDARD = 0;
const int INVCAM_Z_RING_STANDARD = 0;
